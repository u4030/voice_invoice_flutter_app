...
if (speechProvider.state == SpeechState.listening && _hasTriggeredSuccessAnimation) {
...
speechProvider.state == SpeechState.processing &&
...
if (speechProvider.state == SpeechState.listening || speechProvider.state == SpeechState.processing)
const Padding(
